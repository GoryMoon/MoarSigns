...
public class MinecraftIntegration implements ISignRegistration {
    ...
    public void registerMetalSigns(ArrayList<ItemStack> metals) throws IntegrationException {
        SignRegistry.register("iron_sign",      null, "iron",       "", true, new ItemStack(Items.field_191525_da, 1, 0), new ItemStack(Items.IRON_INGOT), new ItemStack(Blocks.IRON_BLOCK), Reference.MODID).setMetal();
